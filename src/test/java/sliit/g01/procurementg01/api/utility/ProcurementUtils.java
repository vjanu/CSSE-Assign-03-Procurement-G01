...
public class ProcurementUtils {
	...
	private AccountingStaff createAccountingStaffBean(String empId, String empName, String empType, String nic,
			String phone) {
	...
	private Rating createRatingBean(String constructorId, String supplierId, String constructorName, int delivery,
			int wotime, int supportive) {
	...
	protected List<AccountingStaff> getAccountingStaffBeans() {
		...
		accountingStaffList
				.add(createAccountingStaffBean("EMP1021", "Sunil Perera", "Permanent", "950120034V", "0765312121"));
		accountingStaffList
				.add(createAccountingStaffBean("EMP1022", "Nima Perera", "Permanent", "960120034V", "0775312331"));
